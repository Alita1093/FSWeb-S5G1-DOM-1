...
//   j = i + 1;
//   navItems[i].textContent = siteContent.nav["nav-item-" + j];
...
const iletisimPar = document.querySelectorAll(".contact p");
iletisimPar[0].textContent = siteContent["iletisim"]["adres"];
iletisimPar[1].textContent = siteContent["iletisim"]["email"];
iletisimPar[2].textContent = siteContent["iletisim"]["telefon"];

const assa = document.querySelector("footer a");
assa.textContent = siteContent["footer"]["copyright"];
assa.setAttribute("class", "bold");
